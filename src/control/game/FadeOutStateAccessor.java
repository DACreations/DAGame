...
public class FadeOutStateAccessor implements TweenAccessor<FadeOutState> {
    ...
    @Override
    public int getValues(FadeOutState fadeInState, int i, float[] floats) {
        switch (i) {
            case 1 -> {
    ...
    @Override
    public void setValues(FadeOutState fadeInState, int i, float[] floats) {
        switch (i) {
            case 1:
